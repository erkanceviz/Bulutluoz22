...
public class Corolla extends BToyota {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(corolla1.seriNo); // Corolla
        ...
        System.out.println("_____________BToyota___________");

        BToyota toyota3=new Corolla();
        System.out.println(toyota3.marka); // BToyota
        System.out.println(toyota3.model); // BToyota
        System.out.println(toyota3.motor); // Araba
        System.out.println(toyota3.plaka); // Araba
        System.out.println(toyota3.yil); // BToyota
